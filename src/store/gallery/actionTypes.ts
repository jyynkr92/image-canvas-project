import { DETAIL_GALLERY_REQUEST, DETAIL_GALLERY_SUCCESS, SET_GALLERY_RESET, ImageInfo, LIST_GALLERY_REQUEST, LIST_GALLERY_SUCCESS } from './types';
...
export type GalleryActionTypes = ListGalleryActionTypes | DetailGalleryActionTypes | SetGalleryResetAction;
